...
# ================================== Others ==================================
from GPDP_DKLRBF import my_exact_gp
...
class GaussianProcessDiffusionQlearning:
    ...
    def loadGPTrainingRecord(self, path=None):
        ...
        self.gp_model.feature_extractor.load_state_dict(_loaded_training_record['gp_feature_extractor'])
        self.gp_model.feature_extractor_optimizer.load_state_dict(_loaded_training_record['gp_feature_extractor_optimizer'])

        self.gp_model.optimizer.load_state_dict(_loaded_training_record['gp_optimizer'])

        _z_train = self.gp_model.feature_extractor(self.gp_model.x_train)
        self.gp_model.K = self.gp_model.rbfKernel(X_1=_z_train, X_2=_z_train, noise=True)
    ...
    def recordSaving(self, path:str):
        torch.save({'training_record': self.training_record,
                    ...
                    'gp_feature_extractor': self.gp_model.feature_extractor.state_dict(), 
                    'gp_feature_extractor_optimizer': self.gp_model.feature_extractor_optimizer.state_dict(),
                    }, path)